...
// 				{
// 					boundingSphereBuffers[i]->ChangeColors(boundingSpheres[i]->redColors);
// 					boundingSphereBuffers[j]->ChangeColors(boundingSpheres[j]->redColors);
// // 					boundingSphereBuffers[i]->SetColor(glm::vec4(1.0f,0.0f,0.0f,1.0f));
// // 					boundingSphereBuffers[j]->SetColor(glm::vec4(1.0f,0.0f,0.0f,1.0f));
// 					//stopTime = true;
// 				}
// 			}
// 		}
